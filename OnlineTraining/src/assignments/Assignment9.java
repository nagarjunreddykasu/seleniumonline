...
1.	Write a program to Add 7 entries of type String into HashMap and then print all the keys in all possible ways.

2.	Write a program to Add 7 entries of type String into HashMap and then print all the values in all possible ways.
