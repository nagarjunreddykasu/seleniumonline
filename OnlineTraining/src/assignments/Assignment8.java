...
3. Write a program to add 6 string objects into HashSet reference and then print the objects using Iterator cursor in the same insertion order.

4. Write a program to add 5 string objects into Set reference and then print the objects in ascending order using 'cursor' & 'for each loop'.
